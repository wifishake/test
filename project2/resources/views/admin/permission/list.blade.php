...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加权限','{{url('admin/permission/create')}}','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
		...
		<tbody>
			...
			<tr class="text-c">
			  {{ csrf_field() }}
				...
				<td>{{ $v->id}} </td>
				<td>{{ $v->node_name}} </td>
				<td>{{ $v->request_address}} </td>
				<td class="td-manage">
				
				<a title="权限编辑" href="javascript:;" onclick="admin_edit('权限编辑','{{ url('admin/permission/'.$v->id.'/edit') }}',1,'800','500')" class="ml-5" style="text-decoration:none">
